 ...
 * @author guest-a
 */
public class SampleFrame1 extends javax.swing.JFrame {

    /**
     * Creates new form SampleFrame1
     */
    public SampleFrame1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 560, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SampleFrame1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SampleFrame1().setVisible(true);
            }
        });
    }
