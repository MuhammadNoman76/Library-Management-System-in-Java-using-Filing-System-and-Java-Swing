       ...
       this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
         ...
         if(data.fileOflogin.isFile()){
           ...
           catch (Exception e) 
           {
              ...
              setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("ProjectImage.png")));
    }
     ...
     public void LoginMethod(){
           ...
           if(data.file.isFile()){
            ...
            while(li.hasNext()){
                ...
                if(jTextField1.getText().equals(e.username) && jPasswordField1.getText().equals(e.password)){   
